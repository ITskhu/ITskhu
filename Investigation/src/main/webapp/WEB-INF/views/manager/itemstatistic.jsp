...
<body class="skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					항목별 통계 <small>설문의 항목별 통계를 확인합니다.</small>
				</h1>
			</section>
			<!-- Main content -->
			<section class="content">
				<div class="row" style="margin: 10px">
					...
					<button type="button" id="button3" class="btn btn-default" style="margin: 5px">선 그래프</button>
					<button type="button" id="button4" class="btn btn-default hide" style="margin: 5px">비교하기</button>
				</div>
				<div class="row" style="margin: 10px">
					<div class="col-md-9">
					...
					<div class="col-md-3" style="height: 200px">
						<div class="box box-info hide">
							<div class="box-header with-border">
					        	<h3 class="box-title">결과 비교 <small>같은 버전의 설문만 가능</small></h3>
					        </div>
					        <div class="box-body">
				            	<form role="form">
				              		<div class="form-group">
				                 		<label>Select</label>
				                  		...
				                  		<button type="button" id="button5" class="btn btn-info pull-right hide" style="margin: 5px">선택</button>
									</div>
								</form>
				            </div>
						</div>
	...
	$(function () {
		...
		var itemAvgStr = '<c:out value="${ItemAvgStr}"/>';
		var itemAvg = itemAvgStr.split(",");
		...
		for(var i=0 ; i< itemArr.length ; i++){
			staticData.data.push(parseFloat(itemAvg[i]));
		}
		...
		$("#button4").click( function(){
			...
			sendData = "stateSeq="+stateSeq+"&version="+version;
			$.ajax({
				url: "/manager/sameversion",
				method: "GET",
				data: sendData,
				dataType: "text",
		...
		$("#button5").click( function(){
			var selectSeq = $("#selectVersion option:selected").val();
			var sendVer = "selectSeq="+selectSeq+"&version="+version;
			$.ajax({
				url: "/manager/compare",
				method: "GET",
				data: sendVer,
